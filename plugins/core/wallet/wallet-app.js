...
`);const _l=/^((?!chrome|android).)*safari/i.test(navigator.userAgent),fl=navigator.userAgent.toLowerCase().indexOf("firefox")>-1;if(_l||fl){const e=document.createElement("style");e.textContent="\n    [scrolling][safari] #outerscroller,\n    [scrolling][firefox] #outerscroller {\n      pointer-events: auto;\n    }\n\n    [ios] #outerscroller {\n      pointer-events: auto;\n      z-index: -3;\n    }\n\n    [ios][scrolling] #outerscroller {\n      z-index: 0;\n    }\n\n    [ios] [frozen] {\n      will-change: auto;\n    }\n  ",ml.querySelector("template").content.appendChild(e)}ml.register("vaadin-grid-styles");const gl=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class bl extends(Ta(ha(ja(Ga(qa(Va(Xa(Za(Qa(Ka(dl(Ba(Ya(cl($a(Wa(ll(el(Ha))))))))))))))))))){static get template(){return Bs`
