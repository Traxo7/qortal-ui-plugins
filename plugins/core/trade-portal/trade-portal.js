...
`);const Ml=/^((?!chrome|android).)*safari/i.test(navigator.userAgent),Hl=navigator.userAgent.toLowerCase().indexOf("firefox")>-1;if(Ml||Hl){const e=document.createElement("style");e.textContent="\n    [scrolling][safari] #outerscroller,\n    [scrolling][firefox] #outerscroller {\n      pointer-events: auto;\n    }\n\n    [ios] #outerscroller {\n      pointer-events: auto;\n      z-index: -3;\n    }\n\n    [ios][scrolling] #outerscroller {\n      z-index: 0;\n    }\n\n    [ios] [frozen] {\n      will-change: auto;\n    }\n  ",Fl.querySelector("template").content.appendChild(e)}Fl.register("vaadin-grid-styles");const Bl=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class Vl extends(Js(Ns(ml(hl(fl(cl(vl(xl(Al(yl(Rl(dl(gl(zl(pl(_l(Ol(wl(ll))))))))))))))))))){static get template(){return ds`
  ...
  <template>
    <style>
      ...
      :host([dir="rtl"]) #scroller:not([ios]) [part~="row"][dragstart]:not([dragstart=""])::after {
        ...
        `}constructor(){super(),this.selectedAddress={},this.config={},this.qortBalance=0,this.sellBtnDisable=!1,this.isSellLoading=!1,this.buyBtnDisable=!0,this.isBuyLoading=!1,this.initialAmount=0,this.openOrders=[]}render(){return F`
