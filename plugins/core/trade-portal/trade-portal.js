...
`);const Kl=/^((?!chrome|android).)*safari/i.test(navigator.userAgent),Ql=navigator.userAgent.toLowerCase().indexOf("firefox")>-1;if(Kl||Ql){const e=document.createElement("style");e.textContent="\n    [scrolling][safari] #outerscroller,\n    [scrolling][firefox] #outerscroller {\n      pointer-events: auto;\n    }\n\n    [ios] #outerscroller {\n      pointer-events: auto;\n      z-index: -3;\n    }\n\n    [ios][scrolling] #outerscroller {\n      z-index: 0;\n    }\n\n    [ios] [frozen] {\n      will-change: auto;\n    }\n  ",Jl.querySelector("template").content.appendChild(e)}Jl.register("vaadin-grid-styles");const Zl=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class ed extends(dl(Ys(Tl(Cl(Il(wl(zl(Nl(Ll(Rl(Ul(Al(Ol(jl(Sl(Pl(ql(Dl(xl))))))))))))))))))){static get template(){return As`
