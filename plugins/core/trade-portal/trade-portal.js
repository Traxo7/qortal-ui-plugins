                            ...
                            <div class="box">
                                ...
                                <div class="border-wrapper">
                                    <vaadin-grid theme="compact column-borders row-stripes wrap-cell-content" id="openOrdersGrid" aria-label="Open Orders" .items="${this.openOrders}">
                                        ...
                                        <vaadin-grid-column header="Price (BTC)" .renderer=${(e,t,i)=>{const r=this.round(parseFloat(i.item.btcAmount)/parseFloat(i.item.qortAmount));L(F`${r}`,e)}}>
                                </vaadin-grid-column>
                            ...
                            <div class="box">
                                ...
                                <div class="border-wrapper">
                                    <vaadin-grid theme="compact column-borders row-stripes wrap-cell-content" id="myOrdersGrid" aria-label="My Orders" .items="${this.myOrders}">
                                        <vaadin-grid-column header="Date" .renderer=${(e,t,i)=>{const r=new Date(i.item.timestamp).toLocaleString();L(F`${r}`,e)}}>
                                </vaadin-grid-column>
                                        <vaadin-grid-column header="Status" path="_tradeState"></vaadin-grid-column>
                                        <vaadin-grid-column header="Price (BTC)" .renderer=${(e,t,i)=>{const r=this.round(parseFloat(i.item.bitcoinAmount)/parseFloat(i.item.qortAmount));L(F`${r}`,e)}}>
                                </vaadin-grid-column>
                                        <vaadin-grid-column header="Amount (QORT)" path="qortAmount"></vaadin-grid-column>
                                        <vaadin-grid-column header="Total (BTC)" path="bitcoinAmount"></vaadin-grid-column>
                                        <vaadin-grid-column width="5rem" flex-grow="0" header="Action" .renderer=${(e,t,i)=>{L(F`${this.renderCancelButton(i.item)}`,e)}}></vaadin-grid-column>
                                    </vaadin-grid>
                                </div>
                            </div>
                        </div>
